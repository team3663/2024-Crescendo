...
public final class Constants {
    ...
    private static final Rotation2d BLUE_AMP_ROTATION = new Rotation2d();
    private static final Rotation2d RED_AMP_ROTATION = new Rotation2d();

    private static final Translation2d BLUE_SPEAKER_POSITION = new Translation2d();
    private static final Translation2d RED_SPEAKER_POSITION = new Translation2d();

    private static final SubwooferRotations BLUE_SUBWOOFER_ROTATIONS = new SubwooferRotations(Rotation2d.fromDegrees(0.0),
            List.of(Rotation2d.fromDegrees(-120.0), Rotation2d.fromDegrees(120.0)));
    private static final SubwooferRotations RED_SUBWOOFER_ROTATIONS = new SubwooferRotations(Rotation2d.fromDegrees(180.0),
